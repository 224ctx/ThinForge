#!/bin/bash
#
# ThinForge — Branding (Wallpaper + Boot-Splash) fuer Manjaro
#
...
#
# Aufruf:
#   sudo bash install-branding-manjaro.sh           # eigenstaendig
#
# Wird ausserdem automatisch aus install-manjaro.sh (finish) aufgerufen.
#
...
# Manjaro nutzt wie Arch mkinitcpio — 'plymouth' als HOOK eintragen
